...
%     addpath('E:\Eyelink_test_ground_Wenqing');
    ...
    sp2_color=[0 0 255 cfg.contrast];
...
Screen('BlendFunction', window, 'GL_SRC_ALPHA', 'GL_ONE_MINUS_SRC_ALPHA');
    ...
    %Eyelink('command','draw_box %d %d %d %d 15',center(1)-(window_fix/2),center(2)-(window_fix/2),center(1)+(window_fix/2),center(2)+(window_fix/2));
